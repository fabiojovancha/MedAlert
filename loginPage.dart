...
class _LoginScreenState extends State<LoginScreen> {
  ...
  String dummyadminpassword = 'admin123';
  String dummyuser = 'user';
  String dummyuserpassword = 'user123';
                      ...
                      Container(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            ...
                            if (_usernameController.text == dummyadmin &&
                            ...
                            } else if (_usernameController.text == dummyuser &&
                              _passwordController.text == dummyuserpassword) {
                              loggedInUsername = _usernameController.text;
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) =>
                                        HomeScreen()), // Navigate to UserPage
                              );
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(content: Text('Logged In as User')),
                              );
                            } else {
                              // Jika login gagal
                              ScaffoldMessenger.of(context).showSnackBar(
